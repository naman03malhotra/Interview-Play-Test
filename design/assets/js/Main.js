...
var ComButton = require('./components/commenceButton');
                        ...
                        <div className="panel panel-default">
                           <div className="panel-heading c-list">
                              ...
                              <ul className="pull-right c-controls">
                                 <li><a href="#cant-do-all-the-work-for-you" data-toggle="tooltip" data-placement="top" title="Add Contact"><i className="glyphicon glyphicon-plus"></i></a></li>
                           ...
                           <div className="row" id="inpSt">
                              ...
                              <MyList listData = {this.props.Data} listType= {canType} />
                                 </ul>
                     ...
                     <div className="col-xs-12 col-md-12">
                        <div className="panel panel-default">
                           ...
                           <div className="row" id="inpSt">
                              <div className="col-xs-12">
                                 <div className="input-group c-search" id="cx2">
                                    <input type="text" className="form-control" id="contact-list-search2"/>
                                    <span className="input-group-btn">
                                       <button className="btn btn-default" type="button"><span className="glyphicon glyphicon-search text-muted"></span></button>
                                    </span>
                                 </div>
                           ...
                           <ul className="list-group" id="contact-list2">
                              <MyList listData={this.props.Data2} listType={intType}/>
